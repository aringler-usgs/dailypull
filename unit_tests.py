...
class UnittestGetData(unittest.TestCase):
	def test_getData_get_availability(self):
		...
		self.assertEqual( getdata.get_availability(read(test_file)) , test_availability )
	def test_getData_check_missing_msd_data(self):
		test_day = UTCDateTime('2015001')
		test_network = 'CU'
		test_case = (['CU.BBGH.00.BH1', 'CU.MTDJ.00.BH2', 'CU.GRTK.20.LN2', 'CU.GRTK.20.LNZ', 'CU.GRTK.20.LN1'], [99.99997106481482, 99.99997106481482, 99.9988425925926, 99.9988425925926, 99.9988425925926])
		self.assertEqual( getdata.check_missing_msd_data( test_day, test_network ), test_case)
...
class UnittestUtil(unittest.TestCase):
	...
	# 	self.assertEqual( util.dsecs(test_time2 - test_time1), test_elapse * 86400 )
